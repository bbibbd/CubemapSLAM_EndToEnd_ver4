...
public:
    ...
    //transform to rig space
    template<class T>
    void cvtFacesToRig(std::vector<float> &rigPt, const cv::Vec<T, 3> &localPt, const eFace &face);
...
//transform to rig space
template<class T>
void CamModelGeneral::cvtFacesToRig(std::vector<float> &rigPt, const cv::Vec<T, 3> &localPt, const eFace &face)
{
